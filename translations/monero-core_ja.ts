...
<context>
    ...
    <message>
        ...
        <translation>Hideringを送ったり受け取ったりするのが簡単になり、アドレスを手で打ち間違えるのを避けられます。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>警告: キーの再利用に関する対策が組み込まれていない限り、Hideringのキーを別のフォークで使い回さないでください。あなたのプライバシーが損なわれます。</translation>
    </message>
    <message>
        ...
        <translation>警告: シードをクリップボードにコピーすると、シードを記録しHideringを盗む悪意あるソフトウェアに晒される可能性があります。シードは手で書き留めてください。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>組み込まれているHideringのバージョン: </translation>
    </message>
    <message>
...
古いウォレットのキャッシュはリネームされ後で復元できます。
    ...
    <message>
        ...
        <translation>Hideringに寄付</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>サードパーティーのサーバを使ってHideringネットワークに接続します。セキュリティは低くなりますがより簡単です。</translation>
    </message>
    <message>
        ...
        <translation>リモートノードを見つけるには、お好きな検索エンジンで&apos;Hidering remote node&apos;と検索してください。ノードが信頼できるサードパーティーによって運営されていることを確認してください。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>このページでは共有リングデータベースを操作できます。このデータベースはHideringウォレットおよびHideringのキーを再利用するHideringクローンのウォレットで利用するためのものです。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>第三者がリング内に既知の使用済みインプットを見つけられないことは、Hideringトランザクションのどのインプットが使用されたのかを隠すために必要です。もし見つけられるとリング署名による保護は弱まります。もし1つのインプットを除いてすべてが使用済みだと知られている場合、実際に使用されたインプットは明らかとなり、Hideringが使っている3つの主要なプライバシー保護レイヤーのうちの1つであるリング署名の効果が失われてしまいます。&lt;br&gt;トランザクションでそれらのインプットを避けるため、既知の使用済みインプットのリストを用いてそれらを新規のトランザクションで使用しないようにできます。このようなリストはHideringプロジェクトによって保守されhidering.orgのウェブサイトで公開されており、ここではこのリストをインポートすることができます。&lt;br&gt;あるいはhidering-blockchain-mark-spent-outputsというツールを使い、Hideringのブロックチェーン(およびキーを再利用するHideringクローンのブロックチェン)を自分でスキャンして既知の使用済みアウトプットのリストを生成できます。&lt;br&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Hideringのリング署名による保護を無効化しないため、あるアウトプットを使う際に異なるブロックチェーンで異なるリングを使うことは避けなければなりません。これは通常問題になりませんが、キーを再利用するHideringクローンが既存のアウトプットの使用を許している場合問題になります。この場合、既存のアウトプットは両方のチェーンで同じリングを使わなくてはなりません。&lt;br&gt;これはキーを再利用するソフトウェアが積極的にプライバシーを侵害しようとしない限り自動的に行われます。&lt;br&gt;もしキーを再利用するHideringクローンを使っていてそのクローンがこの保護を含んでいない場合も、まずクローンの方でアウトプットを使用しその後リングをこのページに手動で追加することで、トランザクションは保護されHideringを安全に使用できるようになります。&lt;br&gt;これらの機能を提供しないキーを再利用するHideringクローンを使用していない場合、すべては自動化されているので何もする必要はありません。&lt;br&gt;</translation>
    </message>
    <message>
        ...
        <translation>キーを再利用するチェーンでアウトプットに使用されたリングを記録し、プライバシーの問題を避けるためHideringでも同じリングを使うようにします。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Hideringアドレス (例: 44AFFq5kSiGBoZ...)</translation>
    </message>
    <message>
...
Confirmation message:
    ...
    <message>
        ...
        <translation>Hideringの送金に成功しました</translation>
    </message>
    <message>
...
アップグレードするか別のデーモンに接続してください</translation>
    ...
    <message>
        ...
        <translation>支出可能な資金: %1 HRG. 全ての残高が利用可能になるまで~%2分ほどお待ちください。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>HRGをコールド(オフライン)ウォレットから消費する</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>hidering.orgを訪問して詳細を確認してください</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>HideringネットワークとやりとりするにはウォレットをHideringノードに接続する必要があります。プライバシーのためにはあなた自身がノードを走らせることを推奨します。</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Hideringをすぐに使いたい場合ブートストラップノードを指定できます。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>もしHideringを使うのが初めてならこのオプションを選んでください。</translation>
    </message>
    <message>
        <location filename="../wizard/WizardHome.qml" line="104"/>
    ...
    <message>
        ...
        <translation>ハードウェアウォレットを接続して新しいHideringウォレットを作成。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Hideringをもうすぐ使いに初めにリモートノードの利用はいいですがリモートノードの使う時に他の人はアドレスを追跡し、復元を開始するブロック高を洞察し、不正確な情報を送信することで、あなたの取引の詳細をもっと洞察できますよ。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>このモードは少額のHideringを扱う場合に適しています。取引を作成したり管理したりする基本的な機能にアクセスできます。Hideringネットワークに自動的に接続するためHideringをすぐに使い始めることができます。</translation>
    </message>
    <message>
...
If you don&apos;t have the option to run your own node, there&apos;s an option to connect to a remote node.</source>
        <translation>HideringネットワークとやりとりするためウォレットはHideringノードに接続する必要があります。プライバシーのため自分自身でノードを走らせることを推奨します。
